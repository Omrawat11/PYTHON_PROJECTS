...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f172a,100:6366f1&height=200&section=header&text=PYTHON%20PROJECTS&fontSize=50&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=Automation%20•%20Games%20•%20Utilities&descAlignY=55&descSize=18" width="100%"/>

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=6366F1&center=true&vCenter=true&width=600&lines=Learning+Python+one+project+at+a+time;Automation+scripts+%7C+Mini+games+%7C+Utilities;Star+%E2%AD%90+if+you+find+something+useful!" alt="Typing SVG" />
...
![psutil](https://img.shields.io/badge/-psutil-4B8BBE?style=flat-square)
![gTTS](https://img.shields.io/badge/-gTTS-EA4335?style=flat-square&logo=googletranslate&logoColor=white)
![qrcode](https://img.shields.io/badge/-qrcode-000000?style=flat-square)
![turtle](https://img.shields.io/badge/-turtle-2E8B57?style=flat-square)
