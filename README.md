...
[![Python](https://img.shields.io/badge/Python-3.7+-3776AB?style=for-the-badge&logo=python&logoColor=white)](https://img.shields.io/badge/Python-3.7+-3776AB?style=for-the-badge&logo=python&logoColor=white)
...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ------------------------ | --------------------------------------------------------------------- |
| 🎧 **Audio Book**              | Converts text or PDF input into an audiobook by reading the content aloud and generating an audio file.                  | `gTTS` / text-to-speech  | [View →](https://github.com/Omrawat11/PYTHON_PROJECTS/tree/main/Audio%20Book) |
...
- [x] Audio Book (text/PDF to speech)
