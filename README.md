...
This repo is where I build and document small, self-contained Python projects while learning — everything from desktop automation and system utilities to simple games and media tools. Each project lives in its own folder with its own code (and a dedicated README for the bigger ones).

## 📂 Projects

| Project | Description | Tech | Link |
|---|---|---|---|
| 🎧 **Audio Book** | Converts text (e.g. a PDF or text file) into a spoken audiobook using text-to-speech. | `pyttsx3` / `gTTS` | [View →](./Audio%20Book) |
...
| Media / Generation | `qrcode`, `gTTS`, `pyttsx3` |
